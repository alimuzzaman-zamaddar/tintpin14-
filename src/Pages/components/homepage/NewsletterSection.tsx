...
export default function NewsletterSection() {
  ...
  return (
    <section className="relative w-full bg-[#030712] text-whitefont-['Outfit'] select-none  pb-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-20">
        ...
        <div className="relative w-full overflow-hidden rounded-3xl border border-white/[0.06] bg-gradient-to-br from-[#060c22] via-[#04091a] to-[#030712] p-8 sm:p-12 lg:p-16 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          ...
          <form 
            ...
            className="flex flex-col sm:flex-row items-center gap-3.5 w-full lg:w-auto max-w-[500px] lg:max-w-none shrink-0"
          >
            {/* Input Box Component */}
            <input
              type="email"
              ...
              className="w-full sm:w-[280px] md:w-[320px] h-12 rounded-xl bg-[#0b132e] border border-white/[0.08] px-5 text-sm font-normal text-white placeholder-[rgba(255,255,255,0.35)] focus:outline-none focus:border-blue-500/50 transition-colors tracking-wide"
            />

            {/* Subscribe Action Button Component */}
            <button
              type="submit"
              className="w-full sm:w-auto h-12 px-7 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold tracking-wide shadow-[0_4px_20px_rgba(36,0,255,0.25)] hover:opacity-95 active:scale-98 transition-all duration-150 shrink-0"
            >
              Subscribe
            </button>
          </form>
